...
<body>
    <div id="app"
        ...
        @php $waPhone = preg_replace('/\D/', '', $content['contact_phone'] ?? '96171036488'); @endphp
        <a href="https://wa.me/{{ $waPhone }}" target="_blank" rel="noopener noreferrer"
            class="fixed bottom-6 right-6 z-50 group flex items-center justify-center w-14 h-14 rounded-full
                   bg-[#25D366] hover:bg-[#20c05a] shadow-lg hover:shadow-xl hover:shadow-[#25D366]/30
            ...
            {{-- WhatsApp icon --}}
            <svg class="relative w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            {{-- Tooltip --}}
            <span class="absolute right-16 px-3 py-1.5 rounded-lg text-xs font-medium whitespace-nowrap shadow-lg
